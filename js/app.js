const questionData = [
  ['Search X in Sorted Array', 'search-x-in-sorted-array', 'Basics', 'O(log n)'],
  ...
  ['First 1 in a Sorted Binary Array', 'first-one-sorted-binary-array', 'Basics', 'O(log n)'],
  ['Kth Missing Positive Number', 'kth-missing-positive-number', 'Basics', 'O(log n)'],
  [
  ...
  ['First and Last Occurrence', 'first-and-last-occurrence', 'Intermediate', 'O(log n)'],
  ['Search in Rotated Sorted Array I', 'search-rotated-sorted-array-i', 'Intermediate', 'O(log n)'],
  [
  ...
  ['Single Element in a Sorted Array', 'single-element-sorted-array', 'Intermediate', 'O(log n)'],
  ...
  ['Find Row with Maximum 1s', 'row-with-maximum-ones', '2D Arrays', 'O(m + n)'],
  ...
  ['Find Nth Root of a Number', 'nth-root-of-number', 'BS on Answer', 'O(log n)'],
  ...
  ['Minimum Speed to Arrive on Time', 'minimum-speed-arrive-on-time', 'BS on Answer', 'O(n log m)'],
  ['Minimum Days to Make M Bouquets', 'minimum-days-make-bouquets', 'BS on Answer', 'O(n log m)'],
  ['Capacity to Ship Packages Within D Days', 'ship-packages-d-days', 'BS on Answer', 'O(n log m)'],
  ['Book Allocation Problem', 'book-allocation-problem', 'BS on Answer', 'O(n log m)'],
  ['Split Array Largest Sum', 'split-array-largest-sum', 'BS on Answer', 'O(n log m)'],
  ['Painter’s Partition Problem', 'painters-partition-problem', 'BS on Answer', 'O(n log m)'],
  [
  ...
  ['Median of Two Sorted Arrays', 'median-two-sorted-arrays', 'BS on Answer', 'O(log min(n,m))'],
